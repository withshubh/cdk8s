...
[Duration](#cdk8s-plus-17-duration)|Represents a length of time.
...
[Size](#cdk8s-plus-17-size)|Represents the amount of digital storage.
...
[SizeConversionOptions](#cdk8s-plus-17-sizeconversionoptions)|Options for how to convert time to a different unit.
[TimeConversionOptions](#cdk8s-plus-17-timeconversionoptions)|Options for how to convert time to a different unit.
...
[SizeRoundingBehavior](#cdk8s-plus-17-sizeroundingbehavior)|Rounding behaviour when converting between units of `Size`.
...
## class Duration 🔹 <a id="cdk8s-plus-17-duration"></a>
...
#### toDays(opts?)🔹 <a id="cdk8s-plus-17-duration-todays"></a>
...
* **opts** (<code>[TimeConversionOptions](#cdk8s-plus-17-timeconversionoptions)</code>)  *No description*
...
#### toHours(opts?)🔹 <a id="cdk8s-plus-17-duration-tohours"></a>
...
#### toHumanString()🔹 <a id="cdk8s-plus-17-duration-tohumanstring"></a>
...
#### toISOString()⚠️ <a id="cdk8s-plus-17-duration-toisostring"></a>
...
#### toIsoString()🔹 <a id="cdk8s-plus-17-duration-toisostring"></a>
...
#### toMilliseconds(opts?)🔹 <a id="cdk8s-plus-17-duration-tomilliseconds"></a>
...
#### toMinutes(opts?)🔹 <a id="cdk8s-plus-17-duration-tominutes"></a>
...
#### toSeconds(opts?)🔹 <a id="cdk8s-plus-17-duration-toseconds"></a>
...
#### *static* days(amount)🔹 <a id="cdk8s-plus-17-duration-days"></a>
...
__Returns__:
* <code>[Duration](#cdk8s-plus-17-duration)</code>

#### *static* hours(amount)🔹 <a id="cdk8s-plus-17-duration-hours"></a>
...
#### *static* millis(amount)🔹 <a id="cdk8s-plus-17-duration-millis"></a>
...
#### *static* minutes(amount)🔹 <a id="cdk8s-plus-17-duration-minutes"></a>
...
#### *static* parse(duration)🔹 <a id="cdk8s-plus-17-duration-parse"></a>
...
#### *static* seconds(amount)🔹 <a id="cdk8s-plus-17-duration-seconds"></a>
...
* **props** (<code>[JobProps](#cdk8s-plus-17-jobprops)</code>)  *No description*
  ...
  * **volumes** (<code>Array<[Volume](#cdk8s-plus-17-volume)></code>)  List of volumes that can be mounted by containers belonging to the pod. __*Default*__: No volumes.
  * **podMetadata** (<code>[ApiObjectMetadata](#cdk8s-apiobjectmetadata)</code>)  The pod metadata. __*Optional*__
  * **ttlAfterFinished** (<code>[Duration](#cdk8s-plus-17-duration)</code>)  Limits the lifetime of a Job that has finished execution (either Complete or Failed). __*Default*__: If this field is unset, the Job won't be automatically deleted.
...
**restartPolicy**?🔹 | <code>[RestartPolicy](#cdk8s-plus-17-restartpolicy)</code> | Restart policy for all containers within the pod.<br/>__*Optional*__
**serviceAccount**?🔹 | <code>[IServiceAccount](#cdk8s-plus-17-iserviceaccount)</code> | The service account used to run this pod.<br/>__*Optional*__
**ttlAfterFinished**?🔹 | <code>[Duration](#cdk8s-plus-17-duration)</code> | TTL before the job is deleted after it is finished.<br/>__*Optional*__
...
* **options** (<code>[CommandProbeOptions](#cdk8s-plus-17-commandprobeoptions)</code>)  Options.
  ...
  * **initialDelaySeconds** (<code>[Duration](#cdk8s-plus-17-duration)</code>)  Number of seconds after the container has started before liveness probes are initiated. __*Default*__: immediate
  * **periodSeconds** (<code>[Duration](#cdk8s-plus-17-duration)</code>)  How often (in seconds) to perform the probe. __*Default*__: Duration.seconds(10) Minimum value is 1.
  ...
  * **timeoutSeconds** (<code>[Duration](#cdk8s-plus-17-duration)</code>)  Number of seconds after which the probe times out. __*Default*__: Duration.seconds(1)
...
## class Size 🔹 <a id="cdk8s-plus-17-size"></a>
...
#### toGibibytes(opts?)🔹 <a id="cdk8s-plus-17-size-togibibytes"></a>
...
* **opts** (<code>[SizeConversionOptions](#cdk8s-plus-17-sizeconversionoptions)</code>)  *No description*
  * **rounding** (<code>[SizeRoundingBehavior](#cdk8s-plus-17-sizeroundingbehavior)</code>)  How conversions should behave when it encounters a non-integer result. __*Default*__: SizeRoundingBehavior.FAIL

__Returns__:
* <code>number</code>

#### toKibibytes(opts?)🔹 <a id="cdk8s-plus-17-size-tokibibytes"></a>
...
#### toMebibytes(opts?)🔹 <a id="cdk8s-plus-17-size-tomebibytes"></a>
...
#### toPebibytes(opts?)🔹 <a id="cdk8s-plus-17-size-topebibytes"></a>
...
#### toTebibytes(opts?)🔹 <a id="cdk8s-plus-17-size-totebibytes"></a>
...
#### *static* gibibytes(amount)🔹 <a id="cdk8s-plus-17-size-gibibytes"></a>
...
__Returns__:
* <code>[Size](#cdk8s-plus-17-size)</code>

#### *static* kibibytes(amount)🔹 <a id="cdk8s-plus-17-size-kibibytes"></a>
...
#### *static* mebibytes(amount)🔹 <a id="cdk8s-plus-17-size-mebibytes"></a>
...
#### *static* pebibyte(amount)🔹 <a id="cdk8s-plus-17-size-pebibyte"></a>
...
#### *static* tebibytes(amount)🔹 <a id="cdk8s-plus-17-size-tebibytes"></a>
...
* **options** (<code>[EmptyDirVolumeOptions](#cdk8s-plus-17-emptydirvolumeoptions)</code>)  - Additional options.
  ...
  * **sizeLimit** (<code>[Size](#cdk8s-plus-17-size)</code>)  Total amount of local storage required for this EmptyDir volume. __*Default*__: limit is undefined
...
**initialDelaySeconds**?🔹 | <code>[Duration](#cdk8s-plus-17-duration)</code> | Number of seconds after the container has started before liveness probes are initiated.<br/>__*Default*__: immediate
**periodSeconds**?🔹 | <code>[Duration](#cdk8s-plus-17-duration)</code> | How often (in seconds) to perform the probe.<br/>__*Default*__: Duration.seconds(10) Minimum value is 1.
...
**timeoutSeconds**?🔹 | <code>[Duration](#cdk8s-plus-17-duration)</code> | Number of seconds after which the probe times out.<br/>__*Default*__: Duration.seconds(1)
...
**sizeLimit**?🔹 | <code>[Size](#cdk8s-plus-17-size)</code> | Total amount of local storage required for this EmptyDir volume.<br/>__*Default*__: limit is undefined
...
**restartPolicy**?🔹 | <code>[RestartPolicy](#cdk8s-plus-17-restartpolicy)</code> | Restart policy for all containers within the pod.<br/>__*Default*__: RestartPolicy.ALWAYS
**serviceAccount**?🔹 | <code>[IServiceAccount](#cdk8s-plus-17-iserviceaccount)</code> | A service account provides an identity for processes that run in a Pod.<br/>__*Default*__: No service account.
**ttlAfterFinished**?🔹 | <code>[Duration](#cdk8s-plus-17-duration)</code> | Limits the lifetime of a Job that has finished execution (either Complete or Failed).<br/>__*Default*__: If this field is unset, the Job won't be automatically deleted.
**volumes**?🔹 | <code>Array<[Volume](#cdk8s-plus-17-volume)></code> | List of volumes that can be mounted by containers belonging to the pod.<br/>__*Default*__: No volumes.
...
## struct SizeConversionOptions 🔹 <a id="cdk8s-plus-17-sizeconversionoptions"></a>
...
Name | Type | Description 
-----|------|-------------
**rounding**?🔹 | <code>[SizeRoundingBehavior](#cdk8s-plus-17-sizeroundingbehavior)</code> | How conversions should behave when it encounters a non-integer result.<br/>__*Default*__: SizeRoundingBehavior.FAIL



## struct TimeConversionOptions 🔹 <a id="cdk8s-plus-17-timeconversionoptions"></a>
...
## enum SizeRoundingBehavior 🔹 <a id="cdk8s-plus-17-sizeroundingbehavior"></a>
