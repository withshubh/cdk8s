...
[StorageUnit](#cdk8s-storageunit)|*No description*
...
```ts
new Size(amount: number, unit: StorageUnit)
```

* **amount** (<code>number</code>)  *No description*
* **unit** (<code>[StorageUnit](#cdk8s-storageunit)</code>)  *No description*
...
## class StorageUnit 🔹 <a id="cdk8s-storageunit"></a>
...
```ts
new StorageUnit(label: string, inKibiBytes: number)
```

* **label** (<code>string</code>)  *No description*
* **inKibiBytes** (<code>number</code>)  *No description*
...
Name | Type | Description 
-----|------|-------------
**inKibiBytes**🔹 | <code>number</code> | <span></span>
**label**🔹 | <code>string</code> | <span></span>
*static* **Gibibytes**🔹 | <code>[StorageUnit](#cdk8s-storageunit)</code> | <span></span>
*static* **Kibibytes**🔹 | <code>[StorageUnit](#cdk8s-storageunit)</code> | <span></span>
*static* **Mebibytes**🔹 | <code>[StorageUnit](#cdk8s-storageunit)</code> | <span></span>
*static* **Pebibytes**🔹 | <code>[StorageUnit](#cdk8s-storageunit)</code> | <span></span>
*static* **Tebibytes**🔹 | <code>[StorageUnit](#cdk8s-storageunit)</code> | <span></span>

### Methods


#### toString()🔹 <a id="cdk8s-storageunit-tostring"></a>
