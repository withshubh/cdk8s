...
[Job](#cdk8s-plus-18-job)|A Job creates one or more Pods and ensures that a specified number of them successfully terminate.
[Pod](#cdk8s-plus-18-pod)|Pod is a collection of containers that can run on a host.
[PodSpec](#cdk8s-plus-18-podspec)|Provides read/write capabilities ontop of a `PodSpecProps`.
[PodTemplate](#cdk8s-plus-18-podtemplate)|Provides read/write capabilities ontop of a `PodTemplateProps`.
[Probe](#cdk8s-plus-18-probe)|Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic.
[Resource](#cdk8s-plus-18-resource)|Base class for all Kubernetes objects in stdk8s.
...
Name|Description
----|-----------
[AddDirectoryOptions](#cdk8s-plus-18-adddirectoryoptions)|Options for `configmap.addDirectory()`.
[CommandProbeOptions](#cdk8s-plus-18-commandprobeoptions)|Options for `Probe.fromCommand()`.
[ConfigMapProps](#cdk8s-plus-18-configmapprops)|Properties for initialization of `ConfigMap`.
[ConfigMapVolumeOptions](#cdk8s-plus-18-configmapvolumeoptions)|Options for the ConfigMap-based volume.
[ContainerProps](#cdk8s-plus-18-containerprops)|Properties for creating a container.
[DeploymentProps](#cdk8s-plus-18-deploymentprops)|Properties for initialization of `Deployment`.
[EmptyDirVolumeOptions](#cdk8s-plus-18-emptydirvolumeoptions)|Options for volumes populated with an empty directory.
[EnvValueFromConfigMapOptions](#cdk8s-plus-18-envvaluefromconfigmapoptions)|Options to specify an envionment variable value from a ConfigMap key.
[EnvValueFromProcessOptions](#cdk8s-plus-18-envvaluefromprocessoptions)|Options to specify an environment variable value from the process environment.
[EnvValueFromSecretOptions](#cdk8s-plus-18-envvaluefromsecretoptions)|Options to specify an environment variable value from a Secret.
[ExposeOptions](#cdk8s-plus-18-exposeoptions)|Options for exposing a deployment via a service.
[HttpGetProbeOptions](#cdk8s-plus-18-httpgetprobeoptions)|Options for `Probe.fromHttpGet()`.
[IngressProps](#cdk8s-plus-18-ingressprops)|Properties for `Ingress`.
[IngressRule](#cdk8s-plus-18-ingressrule)|Represents the rules mapping the paths under a specified host to the related backend services.
[JobProps](#cdk8s-plus-18-jobprops)|Properties for initialization of `Job`.
[MountOptions](#cdk8s-plus-18-mountoptions)|Options for mounts.
[PathMapping](#cdk8s-plus-18-pathmapping)|Maps a string key to a path within a volume.
[PodProps](#cdk8s-plus-18-podprops)|Properties for initialization of `Pod`.
[PodSpecProps](#cdk8s-plus-18-podspecprops)|Properties of a `PodSpec`.
[PodTemplateProps](#cdk8s-plus-18-podtemplateprops)|Properties of a `PodTemplate`.
[ProbeOptions](#cdk8s-plus-18-probeoptions)|Probe options.
[ResourceProps](#cdk8s-plus-18-resourceprops)|Initialization properties for resources.
[SecretProps](#cdk8s-plus-18-secretprops)|*No description*
[SecretValue](#cdk8s-plus-18-secretvalue)|Represents a specific value in JSON secret.
[ServiceAccountProps](#cdk8s-plus-18-serviceaccountprops)|Properties for initialization of `ServiceAccount`.
[ServiceIngressBackendOptions](#cdk8s-plus-18-serviceingressbackendoptions)|Options for setting up backends for ingress rules.
...
Name|Description
----|-----------
[IConfigMap](#cdk8s-plus-18-iconfigmap)|Represents a config map.
[IPodSpec](#cdk8s-plus-18-ipodspec)|Represents a resource that can be configured with a kuberenets pod spec. (e.g `Deployment`, `Job`, `Pod`, ...).
[IPodTemplate](#cdk8s-plus-18-ipodtemplate)|Represents a resource that can be configured with a kuberenets pod template. (e.g `Deployment`, `Job`, ...).
[IResource](#cdk8s-plus-18-iresource)|Represents a resource.
[ISecret](#cdk8s-plus-18-isecret)|*No description*
[IServiceAccount](#cdk8s-plus-18-iserviceaccount)|*No description*
...
## class ConfigMap 🔹 <a id="cdk8s-plus-18-configmap"></a>
...
## class Container 🔹 <a id="cdk8s-plus-18-container"></a>
...
## class Deployment 🔹 <a id="cdk8s-plus-18-deployment"></a>
...
## class EnvValue 🔹 <a id="cdk8s-plus-18-envvalue"></a>
...
#### *static* fromConfigMap(configMap, key, options?)🔹 <a id="cdk8s-plus-18-envvalue-fromconfigmap"></a>
...
* **configMap** (<code>[IConfigMap](#cdk8s-plus-18-iconfigmap)</code>)  - The config map.
* **key** (<code>string</code>)  - The key to extract the value from.
* **options** (<code>[EnvValueFromConfigMapOptions](#cdk8s-plus-18-envvaluefromconfigmapoptions)</code>)  - Additional options.
  * **optional** (<code>boolean</code>)  Specify whether the ConfigMap or its key must be defined. __*Default*__: false

__Returns__:
* <code>[EnvValue](#cdk8s-plus-18-envvalue)</code>

#### *static* fromProcess(key, options?)🔹 <a id="cdk8s-plus-18-envvalue-fromprocess"></a>
...
* **options** (<code>[EnvValueFromProcessOptions](#cdk8s-plus-18-envvaluefromprocessoptions)</code>)  - Additional options.
  * **required** (<code>boolean</code>)  Specify whether the key must exist in the environment. __*Default*__: false

__Returns__:
* <code>[EnvValue](#cdk8s-plus-18-envvalue)</code>

#### *static* fromSecretValue(secretValue, options?)🔹 <a id="cdk8s-plus-18-envvalue-fromsecretvalue"></a>
...
* **secretValue** (<code>[SecretValue](#cdk8s-plus-18-secretvalue)</code>)  The secret value (secrent + key).
* **options** (<code>[EnvValueFromSecretOptions](#cdk8s-plus-18-envvaluefromsecretoptions)</code>)  Additional options.
  * **optional** (<code>boolean</code>)  Specify whether the Secret or its key must be defined. __*Default*__: false

__Returns__:
* <code>[EnvValue](#cdk8s-plus-18-envvalue)</code>

#### *static* fromValue(value)🔹 <a id="cdk8s-plus-18-envvalue-fromvalue"></a>
...
## class Ingress 🔹 <a id="cdk8s-plus-18-ingress"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  *No description*
* **id** (<code>string</code>)  *No description*
* **props** (<code>[IngressProps](#cdk8s-plus-18-ingressprops)</code>)  *No description*
  * **metadata** (<code>[ApiObjectMetadata](#cdk8s-apiobjectmetadata)</code>)  Metadata that all persisted resources must have, which includes all objects users must create. __*Optional*__
  * **defaultBackend** (<code>[IngressBackend](#cdk8s-plus-18-ingressbackend)</code>)  The default backend services requests that do not match any rule. __*Optional*__
  * **rules** (<code>Array<[IngressRule](#cdk8s-plus-18-ingressrule)></code>)  Routing rules for this ingress. __*Optional*__
...
#### addDefaultBackend(backend)🔹 <a id="cdk8s-plus-18-ingress-adddefaultbackend"></a>
...
* **backend** (<code>[IngressBackend](#cdk8s-plus-18-ingressbackend)</code>)  The backend to use for requests that do not match any rule.




#### addHostDefaultBackend(host, backend)🔹 <a id="cdk8s-plus-18-ingress-addhostdefaultbackend"></a>
...
* **backend** (<code>[IngressBackend](#cdk8s-plus-18-ingressbackend)</code>)  The backend to route to.




#### addHostRule(host, path, backend)🔹 <a id="cdk8s-plus-18-ingress-addhostrule"></a>
...
* **backend** (<code>[IngressBackend](#cdk8s-plus-18-ingressbackend)</code>)  The backend to route requests to.




#### addRule(path, backend)🔹 <a id="cdk8s-plus-18-ingress-addrule"></a>
...
#### addRules(...rules)🔹 <a id="cdk8s-plus-18-ingress-addrules"></a>
...
* **rules** (<code>[IngressRule](#cdk8s-plus-18-ingressrule)</code>)  The rules to add.
  * **backend** (<code>[IngressBackend](#cdk8s-plus-18-ingressbackend)</code>)  Backend defines the referenced service endpoint to which the traffic will be forwarded to. 
...
#### protected onValidate()🔹 <a id="cdk8s-plus-18-ingress-onvalidate"></a>
...
## class IngressBackend 🔹 <a id="cdk8s-plus-18-ingressbackend"></a>
...
#### *static* fromService(service, options?)🔹 <a id="cdk8s-plus-18-ingressbackend-fromservice"></a>
...
* **service** (<code>[Service](#cdk8s-plus-18-service)</code>)  The service object.
* **options** (<code>[ServiceIngressBackendOptions](#cdk8s-plus-18-serviceingressbackendoptions)</code>)  *No description*
...
__Returns__:
* <code>[IngressBackend](#cdk8s-plus-18-ingressbackend)</code>



## class Job 🔹 <a id="cdk8s-plus-18-job"></a>
...
## class Pod 🔹 <a id="cdk8s-plus-18-pod"></a>
...
## class PodSpec 🔹 <a id="cdk8s-plus-18-podspec"></a>
...
## class PodTemplate 🔹 <a id="cdk8s-plus-18-podtemplate"></a>
...
## class Probe 🔹 <a id="cdk8s-plus-18-probe"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  *No description*
* **id** (<code>string</code>)  *No description*
* **_** (<code>[ResourceProps](#cdk8s-plus-18-resourceprops)</code>)  *No description*
  * **metadata** (<code>[ApiObjectMetadata](#cdk8s-apiobjectmetadata)</code>)  Metadata that all persisted resources must have, which includes all objects users must create. __*Optional*__
...
## class Secret 🔹 <a id="cdk8s-plus-18-secret"></a>
...
## class Service 🔹 <a id="cdk8s-plus-18-service"></a>
...
## class ServiceAccount 🔹 <a id="cdk8s-plus-18-serviceaccount"></a>
...
## class Volume 🔹 <a id="cdk8s-plus-18-volume"></a>
...
## struct AddDirectoryOptions 🔹 <a id="cdk8s-plus-18-adddirectoryoptions"></a>
...
## struct CommandProbeOptions 🔹 <a id="cdk8s-plus-18-commandprobeoptions"></a>
...
## struct ConfigMapProps 🔹 <a id="cdk8s-plus-18-configmapprops"></a>
...
## struct ConfigMapVolumeOptions 🔹 <a id="cdk8s-plus-18-configmapvolumeoptions"></a>
...
## struct ContainerProps 🔹 <a id="cdk8s-plus-18-containerprops"></a>
...
## struct DeploymentProps 🔹 <a id="cdk8s-plus-18-deploymentprops"></a>
...
## struct EmptyDirVolumeOptions 🔹 <a id="cdk8s-plus-18-emptydirvolumeoptions"></a>
...
## struct EnvValueFromConfigMapOptions 🔹 <a id="cdk8s-plus-18-envvaluefromconfigmapoptions"></a>
...
## struct EnvValueFromProcessOptions 🔹 <a id="cdk8s-plus-18-envvaluefromprocessoptions"></a>
...
## struct EnvValueFromSecretOptions 🔹 <a id="cdk8s-plus-18-envvaluefromsecretoptions"></a>
...
## struct ExposeOptions 🔹 <a id="cdk8s-plus-18-exposeoptions"></a>
...
## struct HttpGetProbeOptions 🔹 <a id="cdk8s-plus-18-httpgetprobeoptions"></a>
...
#### addContainer(container)🔹 <a id="cdk8s-plus-18-ipodspec-addcontainer"></a>
...
#### addContainer(container)🔹 <a id="cdk8s-plus-18-ipodtemplate-addcontainer"></a>
...
## struct IngressProps 🔹 <a id="cdk8s-plus-18-ingressprops"></a>
...
Name | Type | Description 
-----|------|-------------
**defaultBackend**?🔹 | <code>[IngressBackend](#cdk8s-plus-18-ingressbackend)</code> | The default backend services requests that do not match any rule.<br/>__*Optional*__
**metadata**?🔹 | <code>[ApiObjectMetadata](#cdk8s-apiobjectmetadata)</code> | Metadata that all persisted resources must have, which includes all objects users must create.<br/>__*Optional*__
**rules**?🔹 | <code>Array<[IngressRule](#cdk8s-plus-18-ingressrule)></code> | Routing rules for this ingress.<br/>__*Optional*__



## struct IngressRule 🔹 <a id="cdk8s-plus-18-ingressrule"></a>
...
## struct JobProps 🔹 <a id="cdk8s-plus-18-jobprops"></a>
...
## struct MountOptions 🔹 <a id="cdk8s-plus-18-mountoptions"></a>
...
## struct PathMapping 🔹 <a id="cdk8s-plus-18-pathmapping"></a>
...
## struct PodProps 🔹 <a id="cdk8s-plus-18-podprops"></a>
...
## struct PodSpecProps 🔹 <a id="cdk8s-plus-18-podspecprops"></a>
...
## struct PodTemplateProps 🔹 <a id="cdk8s-plus-18-podtemplateprops"></a>
...
## struct ProbeOptions 🔹 <a id="cdk8s-plus-18-probeoptions"></a>
...
## struct ResourceProps 🔹 <a id="cdk8s-plus-18-resourceprops"></a>
...
## struct SecretProps 🔹 <a id="cdk8s-plus-18-secretprops"></a>
...
## struct SecretValue 🔹 <a id="cdk8s-plus-18-secretvalue"></a>
...
## struct ServiceAccountProps 🔹 <a id="cdk8s-plus-18-serviceaccountprops"></a>
...
## struct ServiceIngressBackendOptions 🔹 <a id="cdk8s-plus-18-serviceingressbackendoptions"></a>
...
## struct ServicePort 🔹 <a id="cdk8s-plus-18-serviceport"></a>
...
## struct ServicePortOptions 🔹 <a id="cdk8s-plus-18-serviceportoptions"></a>
...
## struct ServiceProps 🔹 <a id="cdk8s-plus-18-serviceprops"></a>
...
## struct VolumeMount 🔹 <a id="cdk8s-plus-18-volumemount"></a>
