...
[PodProps](#cdk8s-plus-19-podprops)|Properties for initialization of `Pod`.
...
__Implements__: [IConstruct](#constructs-iconstruct), [IResource](#cdk8s-plus-19-iresource), [IConfigMap](#cdk8s-plus-19-iconfigmap), [IResource](#cdk8s-plus-19-iresource)
...
#### toISOString()⚠️ <a id="cdk8s-plus-19-duration-toisostring"></a>
...
#### toSeconds(opts?)🔹 <a id="cdk8s-plus-19-duration-toseconds"></a>
...
* **service** (<code>[Service](#cdk8s-plus-19-service)</code>)  The service object.
...
#### *static* kibibytes(amount)🔹 <a id="cdk8s-plus-19-size-kibibytes"></a>
...
__Implemented by__: [Deployment](#cdk8s-plus-19-deployment), [Job](#cdk8s-plus-19-job), [PodTemplate](#cdk8s-plus-19-podtemplate)
...
## struct ProbeOptions 🔹 <a id="cdk8s-plus-19-probeoptions"></a>
...
## struct ResourceProps 🔹 <a id="cdk8s-plus-19-resourceprops"></a>
...
## struct SecretProps 🔹 <a id="cdk8s-plus-19-secretprops"></a>
...
## struct SecretValue 🔹 <a id="cdk8s-plus-19-secretvalue"></a>
...
## struct ServiceAccountProps 🔹 <a id="cdk8s-plus-19-serviceaccountprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[ApiObjectMetadata](#cdk8s-apiobjectmetadata)</code> | Metadata that all persisted resources must have, which includes all objects users must create.<br/>__*Optional*__
**secrets**?🔹 | <code>Array<[ISecret](#cdk8s-plus-19-isecret)></code> | List of secrets allowed to be used by pods running using this ServiceAccount.<br/>__*Optional*__



## struct ServiceIngressBackendOptions 🔹 <a id="cdk8s-plus-19-serviceingressbackendoptions"></a>
...
## struct ServicePort 🔹 <a id="cdk8s-plus-19-serviceport"></a>
...
## struct ServicePortOptions 🔹 <a id="cdk8s-plus-19-serviceportoptions"></a>
...
## struct ServiceProps 🔹 <a id="cdk8s-plus-19-serviceprops"></a>
...
**metadata**?🔹 | <code>[ApiObjectMetadata](#cdk8s-apiobjectmetadata)</code> | Metadata that all persisted resources must have, which includes all objects users must create.<br/>__*Optional*__
**ports**?🔹 | <code>Array<[ServicePort](#cdk8s-plus-19-serviceport)></code> | The port exposed by this service.<br/>__*Optional*__
**type**?🔹 | <code>[ServiceType](#cdk8s-plus-19-servicetype)</code> | Determines how the Service is exposed.<br/>__*Default*__: ServiceType.ClusterIP



## struct SizeConversionOptions 🔹 <a id="cdk8s-plus-19-sizeconversionoptions"></a>
...
Name | Type | Description 
-----|------|-------------
**rounding**?🔹 | <code>[SizeRoundingBehavior](#cdk8s-plus-19-sizeroundingbehavior)</code> | How conversions should behave when it encounters a non-integer result.<br/>__*Default*__: SizeRoundingBehavior.FAIL



## struct TimeConversionOptions 🔹 <a id="cdk8s-plus-19-timeconversionoptions"></a>
...
## struct VolumeMount 🔹 <a id="cdk8s-plus-19-volumemount"></a>
...
## enum EmptyDirMedium 🔹 <a id="cdk8s-plus-19-emptydirmedium"></a>
...
## enum ImagePullPolicy 🔹 <a id="cdk8s-plus-19-imagepullpolicy"></a>
...
## enum MountPropagation 🔹 <a id="cdk8s-plus-19-mountpropagation"></a>
...
## enum Protocol 🔹 <a id="cdk8s-plus-19-protocol"></a>
...
## enum RestartPolicy 🔹 <a id="cdk8s-plus-19-restartpolicy"></a>
...
## enum ServiceType 🔹 <a id="cdk8s-plus-19-servicetype"></a>
...
## enum SizeRoundingBehavior 🔹 <a id="cdk8s-plus-19-sizeroundingbehavior"></a>
